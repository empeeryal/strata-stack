...
Without a container, the **Migrate database** GitHub Actions workflow applies the same migrations
to a Turso database; see [CI and releases](/docs/guides/ci-cd#database-migrations).
