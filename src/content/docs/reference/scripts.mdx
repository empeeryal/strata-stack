...
| `pnpm db:prune`      | Delete archived contact messages past retention and expired throttle counters |
| `pnpm admin:promote` | Grant (or `--revoke`) the admin role for an existing account                  |
