...
| `pnpm db:prune`      | Delete archived messages past `CONTACT_RETENTION_DAYS`, any message past `CONTACT_MAX_AGE_DAYS` (when set) and expired throttle counters; the **Prune data** workflow runs it weekly |
