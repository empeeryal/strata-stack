...
so a retry from the visitor cannot create a duplicate; administrators resend it from the
[inbox](/docs/guides/admin). The success message tells visitors the message was _received_ and
only promises a reply when one is needed.
