...
provider or contact recipient is logged as a warning. `/api/health` reports the same facts.
...
visitors and renders the 404 page for signed-in users without the role.
